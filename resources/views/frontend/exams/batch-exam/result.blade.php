                            ...
                            @if ($exam->content_type == 'exam')
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="fail-div">
                                                <div class="text-center">
                                                    <img src="{{ asset('/') }}backend/assets/images/xm-ressult/feeling.png"
                                                        alt="" class="img-fluid" style="height: 300px" />
                                        ...
                                        <div>
                                            <h3>Go Back to :</h3>
                                            <a href="{{ route('front.student.batch-exam-contents', ['xm_id' => $exam->batchExamSection->batchExam->id, 'master' => base64_encode($exam->batchExamSection->batchExam->is_master_exam), 'slug' => str_replace(' ', '-', $exam->batchExamSection->batchExam->title)]) }}"
