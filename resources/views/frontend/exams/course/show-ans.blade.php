                            ...
                            <div class="row g-4 align-items-center answer-sheet-total">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="exam-all-marks">
                                                ...
                                                <h6>Negative Mark : <span> {{ $content->exam_negative_mark * $courseExamResult->total_wrong_ans}}</span></h6>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="exam-all-marks">
                                                <h6>Wrong Ans: <span>{{ $courseExamResult->total_wrong_ans ?? 0 }}</span></h6>
                                                <h6>Right Ans : <span>{{ $courseExamResult->total_right_ans ?? 0 }}</span></h6>
                                                <h6>Obtained Mark : <span><span>{{ $courseExamResult->result_mark ?? 0 }}  ({{ $courseExamResult->status }})</span></h6>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="exam-all-marks exam-time">
                                                ...
                                                @php
                                                    $seconds = $courseExamResult->required_time ?? 0;
                                ...
                                <div class="col-lg-3">
                                    <div class="see-ranking-button">
                                        <a href="{{ route('front.student.show-course-exam-ranking', ['content_id' => $content->id, 'slug' => str_replace(' ', '-', $content->title)]) }}" type="submit" class="">See Ranking</a>
                                    </div>
                                </div>
                            </div>
                        @endif
