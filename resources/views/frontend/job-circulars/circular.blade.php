    ...
    iframe {
     ...
     /* @media (max-width: 767px) {
      iframe {
        ...
        transform-origin: 0 0; /* Keep the content anchored to the top-left corner */
        width: 100%; /* Increase width to maintain proportionality after scaling */
        height: 100%; /* Increase height to maintain proportionality after scaling */
      }
    } */
  </style>
@endpush
