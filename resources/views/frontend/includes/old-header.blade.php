            ...
            <div class="mobile-responsive-menu">
                <div class="logo">
                    {{-- <a href="{{ route('front.home') }}">
                        <img src="{{ asset(isset($siteSettings) ? $siteSettings->logo : 'frontend/assets-old/images/logos/logo-small.png') }}"
                            class="logo-one" alt="logo">
                        <img src="{{ asset(isset($siteSettings) ? $siteSettings->logo : 'frontend/assets-old/images/logos/logo-small-white.png') }}"
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-md navbar-light ">
                {{-- <a class="navbar-brand" href="{{ route('front.home') }}">
                    <img src="{{ asset(isset($siteSettings) ? $siteSettings->logo : 'frontend/assets-old/images/logos/logo.png') }}"
                        class="logo-one" alt="Logo">
                    <img src="{{ asset(isset($siteSettings) ? $siteSettings->logo : 'frontend/assets-old/images/logos/logo-2.png') }}"
                        class="logo-two" alt="Logo">
                </a> --}}
                <a href="index.html"><img src="{{ asset('frontend') }}/assets/images/logo/biddabari-logo.png" alt="Logo"
                    srcset=""></a>
