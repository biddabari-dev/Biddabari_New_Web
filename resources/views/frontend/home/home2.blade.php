                                    ...
                                    <div class="hero-content ms-3">
                                        ...
                                        <div class="banner-btn">
                                            <button type="button" class="default-btn border-radius-50 text-dark f-s-22"
                                                style="background-color: #dedede!important;">ভর্তি হতে এখানে ক্লিক
                                                করুন</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="blog-card">
                                <div class="book-btn-sec">
                                    ...
                                    <a href="{{ route('front.view-cart', [$product->id]) }}" class="default-btn ">এখনই
                                        কিনুন</a>
                                    {{-- @else
                                        @if ($stockStatus == true)
                                ...
                                <div class="content">
                                    <h3><a
                                            href="{{ route('front.product-details', ['id' => $product->id, 'slug' => $product->slug]) }}">{{ Str::limit($product->title, 30) ?? '' }}</a>
                                    </h3>
                                    @if ($stockStatus == true)
...
@push('style')
    ...
    <style>
.modal{
    z-index: 9999;  position: fixed; left: 0px; top: 0px; width: 100%; height: 100%;
}

        .model_custome .modal-header {
            padding: 3px;
        }
