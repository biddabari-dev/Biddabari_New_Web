...
<section id="Home_add">
    <div class="home-1st-add-image">
        <img src="{{ asset('frontend') }}/assets/images/home-page/home-page-bn.webp" alt="Home 1st Add Banner" srcset="">
    </div>
</section>
                ...
                <div class="col-md-12 col-lg-8">
                    <div class="home-1st-slide">
                        <div class="variable-width">
                            <div class="home-1st-slide-img">
                                <a href="">
                                    <img src="{{ asset('frontend') }}/assets/images/home-page/home-1st-slide.png" alt="Banner Image"
                                        srcset=""></a>
                            </div>
                            <div class="home-1st-slide-img">
                                <a href="">
            ...
            <div class="home-category-area pb-5">
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="my-home-category">
                            <div class="my-home-category-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/category/guideline.png" alt="" srcset="">
                            </div>
                            <div class="my-home-category-content">
                                <h3>গাইডলাইন</h3>
                                <p>প্রতিযোগিতামূলক এই জব-মার্কেটে নিজের ক্যারিয়ারকে</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="my-home-category">
                            <div class="my-home-category-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/category/teachers.png" alt="" srcset="">
                            </div>
                            <div class="my-home-category-content">
                                <h3>শিক্ষকবৃন্দ</h3>
                                <p>প্রতিযোগিতামূলক এই জব-মার্কেটে নিজের ক্যারিয়ারকে</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="my-home-category">
                            <div class="my-home-category-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/category/media.png" alt="" srcset="">
                            </div>
                            <div class="my-home-category-content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="my-home-category">
                            <div class="my-home-category-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/category/jobcircular.png" alt="" srcset="">
                            </div>
                            <div class="my-home-category-content">
                                <h3>জব সার্কুলার</h3>
                                <p>প্রতিযোগিতামূলক এই জব-মার্কেটে নিজের ক্যারিয়ারকে</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="my-home-category">
                            <div class="my-home-category-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/category/questions.png" alt="" srcset="">
                            </div>
                            <div class="my-home-category-content">
            ...
            <div class="home-services-area">
                <div class="row">
                    <div class="col-md-6">
                        <div class="my-home-service">
                            <div class="my-home-service-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/our-service/job.png" alt="" srcset="">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="my-home-service">
                            <div class="my-home-service-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/our-service/Group 1000007140.png" alt=""
                                    srcset="">
                            </div>
                            <div class="my-home-service-content">
                                <h3>আমাদের বিদাবাড়ি</h3>
                    ...
                    <div class="col-md-6">
                        <div class="my-home-service">
                            <div class="my-home-service-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/our-service/exam.png" alt="" srcset="">
                            </div>
                            <div class="my-home-service-content">
                                <h3>আমাদের বিদাবাড়ি</h3>
                                <p>প্রতিযোগিতামূলক এই জব-মার্কেটে নিজের ক্যারিয়ারকে</p>
                    ...
                    <div class="col-md-6">
                        <div class="my-home-service">
                            <div class="my-home-service-icon">
                                <img src="{{ asset('frontend') }}/assets/images/home-page/our-service/Group 1000007142.png" alt=""
                                    srcset="">
                            </div>
                            <div class="my-home-service-content">
                                <h3>আমাদের বিদাবাড়ি</h3>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="event-area-content">
                                <div class="event-icon">
                                    <img src="{{ asset('frontend') }}/assets/images/home-page/live-exam.png" alt="" srcset="">
                                </div>
                            ...
                            <div class="our-story-video-area">
                                <div class="video-wrapper">
                                    <div class="our-story-video-2">
                                        <iframe
                                            src="https://www.youtube.com/embed/bhCWhEosa3Y?si=myZrYsOTKstGK0zx"
                                    ...
                                    <div class="our-story-video-1">
                                        <iframe
                                            src="https://www.youtube.com/embed/zNiZcVFfX6k?si=pQ-zTm2HE2XkNfii"
                                            title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                            referrerpolicy="strict-origin-when-cross-origin"
                                            allowfullscreen></iframe>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="student-review-content">
                            <div class="student-image">
                                <img src="https://biddabari-bucket.obs.as-south-208.rcloud.reddotdigitalit.com/{{ $successStudentOpinion->image ?? 'frontend/assets/images/testimonials/s-1.jpg' }}" alt="" srcset="" class="img img-thumbnail p-2">
                            </div>
                ...
                <div class="card card-body p-0">
                    ...
                    @if (!empty($poppup->active_btn_link))
                        <div class="btn-link p-0">
                            <a class="btn-sm ms-auto" href="{{ $poppup->active_btn_link ?? '' }}">{{ $poppup->action_btn_text ?? '' }}</a>
                        </div>
                    @endif
                </div>
            </div>
