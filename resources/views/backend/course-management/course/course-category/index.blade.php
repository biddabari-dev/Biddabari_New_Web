        ...
        $(document).on('click', '.category-edit-btn', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        $('#imagePreview2').attr('src', 'https://biddabaribucket.s3.ap-southeast-1.amazonaws.com/'+data.second_image).css({height: '150px', width: '150px', marginTop: '5px', display: 'block'});
                    }
